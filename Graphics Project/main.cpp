...
/**
void lineMidPoint(HDC hdc, int x1,int x2,int y1,int y2)
{
...
void AddMenu(HWND hwnd)
{
    ...
    AppendMenu(circleMenu, MF_POPUP, (UINT_PTR) PolarMenu, "Polar");
    AppendMenu(circleMenu, MF_POPUP, (UINT_PTR) IterativeMenu, "iterativePolar");
    AppendMenu(circleMenu, MF_POPUP, (UINT_PTR) MidpointMenu, "midPointCircle");
    AppendMenu(circleMenu, MF_POPUP, (UINT_PTR) ModifiedMidMenu, "modifiedCircleMidpoint");
